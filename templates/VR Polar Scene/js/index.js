...
loader.load("master/rocks.js", function(geometry, materials) {
...
//===================================================== add model
var loader = new THREE.LegacyJSONLoader();
loader.load("master/glacier.js", function(geometry, materials) {
...
//===================================================== add model
var loader = new THREE.LegacyJSONLoader();
loader.load("master/iceberg.js", function(geometry, materials) {
  var obj = new THREE.Mesh(geometry, materials);
  obj.scale.set(4,1,4);
  obj.castShadow = true;
...
//===================================================== add sky particles
  ...
  const imageSrc = textureLoader.load('master/snowflake.png');
...
if (window.innerWidth > 768) {
  ...
  loader.load('master/single-leaf.js', function(geometry, materials) {
...
function loadModels() {
  ...
  loader.load('master/PolarBear.glb', function(gltf){
  ...
  loader.load('master/PolarCub.glb', function(gltf){
    var model = gltf.scene.children[ 0 ];
...
//=========================================================================================== model
  loader = new THREE.LegacyJSONLoader();
  loader.load('master/igloo.js', function(geometry, materials) {
